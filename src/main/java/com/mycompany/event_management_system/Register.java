...
public class Register extends JFrame {
    JLabel l[] = new JLabel[]{new JLabel("Id"),new JLabel("Username"),new JLabel("contact_no"),new JLabel("Email"),new JLabel("Password")}; 
    JTextField t[] = new JTextField[4];
    JPasswordField p1;
    JButton b1;
    Register(){
        ImageIcon i1 = new ImageIcon("C:/Users/salai/OneDrive/Documents/NetBeansProjects/event_management_system/src/main/java/com/mycompany/event_management_system/images/event2.jpg");
        ...
        b1.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                ...
                String q = null;
                 try{
                     String x = "customer";
                     q = "insert into users values("+t[0].getText()+", '"+t[1].getText()+"', "+t[2].getText()+", '"+t[3].getText()+"','"+x+"','"+p1.getText()+"')";
                        System.out.print(q);
                        setVisible(false);
