...
public class Venue extends JFrame {
    ...
    private String name,hotelimage,facilities,description,capacity,price;
...
//                    add(l1);
    ...
    void addvenue(String name,String image_url,String capacity,String price,String facilities,String description){
        conn c =new conn();
        String q = "insert into venue values('"+name+"', '"+hotelimage+"', "+capacity+", "+price+", '"+facilities+"', '"+description+"' )";
        System.out.print(q);
